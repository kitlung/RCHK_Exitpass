// Kiosk API of KP Enterprise (9.0.5.7512)
...
// Square Payment API:
if (typeof(kp_SquarePaymentAPI_loginWithDeviceCode) !== "function")
{
	function kp_SquarePaymentAPI_loginWithDeviceCode(deviceCode,callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_loginWithDeviceCode?" + encodeURIComponent(deviceCode) + "&" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_loginWithDeviceCode'] = function(deviceCode,callback) { kp_SquarePaymentAPI_loginWithDeviceCode(deviceCode,callback); };
}

if (typeof(kp_SquarePaymentAPI_loggedDeviceCode) !== "function")
{
	function kp_SquarePaymentAPI_loggedDeviceCode(callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_loggedDeviceCode?" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_loggedDeviceCode'] = function(callback) { kp_SquarePaymentAPI_loggedDeviceCode(callback); };
}

if (typeof(kp_SquarePaymentAPI_logout) !== "function")
{
	function kp_SquarePaymentAPI_logout(callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_logout?" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_logout'] = function(callback) { kp_SquarePaymentAPI_logout(callback); };
}

if (typeof(kp_SquarePaymentAPI_sendTransaction) !== "function")
{
	function kp_SquarePaymentAPI_sendTransaction(amount,type,note,customerID,callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_sendTransaction?" + encodeURIComponent(amount) + "&" + encodeURIComponent(type) + "&" + encodeURIComponent(note) + "&" + encodeURIComponent(customerID) + "&" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_sendTransaction'] = function(amount,type,note,customerID,callback) { kp_SquarePaymentAPI_sendTransaction(amount,type,note,customerID,callback); };
}

if (typeof(kp_SquarePaymentAPI_sendTransactionEx) !== "function")
{
	function kp_SquarePaymentAPI_sendTransactionEx(amount,type,note,customerID,config,callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_sendTransactionEx?" + encodeURIComponent(amount) + "&" + encodeURIComponent(type) + "&" + encodeURIComponent(note) + "&" + encodeURIComponent(customerID) + "&" + encodeURIComponent(config) + "&" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_sendTransactionEx'] = function(amount,type,note,customerID,config,callback) { kp_SquarePaymentAPI_sendTransactionEx(amount,type,note,customerID,config,callback); };
}

if (typeof(kp_SquarePaymentAPI_presentCardReaderManagementUI) !== "function")
{
	function kp_SquarePaymentAPI_presentCardReaderManagementUI(callback)
	{
		___kp_executeURL("kioskpro://kp_SquarePaymentAPI_presentCardReaderManagementUI?" + encodeURIComponent(callback));
	}
}

for (_kp_i_ = 0; _kp_i_ < _kp_frames_special_.length; ++_kp_i_)
{
	_kp_frames_special_[_kp_i_].contentWindow['kp_SquarePaymentAPI_presentCardReaderManagementUI'] = function(callback) { kp_SquarePaymentAPI_presentCardReaderManagementUI(callback); };
}
